...
![](/img/20210924015528363887.png)

使用盲注对SQL注入进行测试

![](/img/20210924015528586858.png)

触发了通达OA的SQL注入拦截

**inc/conn.php**文件中找到过滤机制如下:

![](/img/20210924015528786833.png)
...
![](/img/20210924015529019464.png)

![](/img/20210924015529252471.png)
