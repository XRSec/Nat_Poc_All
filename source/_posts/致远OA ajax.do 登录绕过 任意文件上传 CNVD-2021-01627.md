---
title: 致远OA ajax.do 登录绕过 任意文件上传 CNVD-2021-01627
...
webshell地址: http://xxx.xxx.xxx.xxx/seeyon/apps_res/addressbook/images/config.jspx
```
...
![](/img/20210924013856553409.png)

上传后请求webshell地址，访问返回出现如下图则成功写入

![](/img/20210924013856816548.png)
