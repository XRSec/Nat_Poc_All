...
![](/img/20210924013846523626.png)

在getData方法中，判断请求里cmd参数是否为空，如果不为空，调用proc方法

![](/img/20210924013847798239.png)
...
![](/img/20210924013848445315.png)

解密后即可登录系统

![](/img/20210924013848912688.png)
