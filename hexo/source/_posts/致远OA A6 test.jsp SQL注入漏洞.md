...
![](/img/20210924013525117131.png)

返回了当前使用的数据库

要想写入shell需要知道写入的路径

![](/img/20210924013525341595.png)
